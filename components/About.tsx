          ...
          <div className="md:w-2/5">
            ...
            <div className="flex flex-wrap gap-3 mb-3">
              {skills.map((skill) => (
                <span 
                  key={skill}
                  className="px-4 py-2 rounded-full text-sm font-medium bg-slate-200 text-slate-800 dark:bg-slate-700 dark:text-slate-200 hover:shadow-xl dark:hover:shadow-blue-900/20 transition-all duration-300 transform hover:-translate-y-1"
                >
                  {skill}
                </span>
              ))}
